...
typedef struct
{
  __IO uint32_t ISER[8];                      /*!< Offset: 0x000  Interrupt Set Enable Register ÖÐ¶ÏÉèÖÃÊ¹ÄÜ¼Ä´æÆ÷          */
       uint32_t RESERVED0[24];                                   
  __IO uint32_t ICER[8];                      /*!< Offset: 0x080  Interrupt Clear Enable Register ÖÐ¶ÏÇå³ýÊ¹ÄÜ¼Ä´æÆ÷        */
       uint32_t RSERVED1[24];                                    
  __IO uint32_t ISPR[8];                      /*!< Offset: 0x100  Interrupt Set Pending Register  ÖÐ¶ÏÉèÖÃ¹ÒÆð¼Ä´æÆ÷        */
       uint32_t RESERVED2[24];                                   
  __IO uint32_t ICPR[8];                      /*!< Offset: 0x180  Interrupt Clear Pending Register  ÖÐ¶ÏÇå³ý¹ÒÆð¼Ä´æÆ÷      */
       uint32_t RESERVED3[24];                                   
  __IO uint32_t IABR[8];                      /*!< Offset: 0x200  Interrupt Active bit Register  ÖÐ¶Ï»îÔ¾Î»¼Ä´æÆ÷         */
       uint32_t RESERVED4[56];                                   
  __IO uint8_t  IP[240];                      /*!< Offset: 0x300  Interrupt Priority Register (8Bit wide) ÖÐ¶ÏÓÅÏÈ¼¶¼Ä´æÆ÷*/
       uint32_t RESERVED5[644];                                  
  __O  uint32_t STIR;                         /*!< Offset: 0xE00  Software Trigger Interrupt Register  Èí¼þ´¥·¢ÖÐ¶Ï¼Ä´æÆ÷   */
}  NVIC_Type;                                               
